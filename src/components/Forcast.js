...
function Forcast() {
  ...
  return (
    <div className="flex justify-between items-center bg-gray-800 p-4 rounded-lg w-9/12 mt-6">
        {forecast?.map((item, index) => {
            return(
        <div key={index} className="flex flex-col items-center justify-center bg-[#0B131E] p-4 rounded-lg w-[13%] h-44">
